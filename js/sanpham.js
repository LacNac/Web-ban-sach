const books = [
    {
        ...
        rating: 4.7,
        price: "79.000đ",
        summary: "Tác phẩm kinh điển thiếu nhi Việt Nam kể về hành trình trưởng thành của Dế Mèn qua nhiều chuyến phiêu lưu.",
        image: "https://doctruyencotich.vn/upload/icon/20210115/de-men-phieu-luu-ky-chuong-4-cua-nha-van-to-hoai.png"
    },
    {
        id: 2,
        title: "Nhà Giả Kim",
        ...
        rating: 4.8,
        price: "95.000đ",
        summary: "Câu chuyện về cậu bé chăn cừu Santiago đi tìm kho báu và khám phá ý nghĩa của ước mơ.",
    ...
    },
    {
        ...
        rating: 4.9,
        price: "120.000đ",
        summary: "Phần mở đầu của series Harry Potter, nơi cậu bé phù thủy bắt đầu năm học đầu tiên ở Hogwarts.",
    ...
    },
    {
        ...
        rating: 4.8,
        price: "210.000đ",
        summary: "Tuyển tập những vụ án nổi tiếng của thám tử Sherlock Holmes cùng bác sĩ Watson.",
    ...
    },
    {
        ...
        rating: 4.6,
        price: "145.000đ",
        summary: "Tiểu thuyết về những thiếu niên trong kháng chiến, giàu cảm xúc và tinh thần yêu nước.",
        image: "https://www.netabooks.vn/Data/Sites/1/Product/28109/tuoi-tho-du-doi-tap-1-2.jpg"
    },
    {
        id: 6,
        title: "Đắc Nhân Tâm",
        ...
        rating: 4.7,
        price: "89.000đ",
        summary: "Cuốn sách kinh điển về nghệ thuật giao tiếp, thuyết phục và xây dựng các mối quan hệ tích cực.",
    ...
    },
    {
        ...
        rating: 4.5,
        price: "85.000đ",
        summary: "Truyện ngắn nổi tiếng về lòng kiên trì và phẩm giá con người trước nghịch cảnh.",
        image: "https://www.netabooks.vn/Data/Sites/1/Product/37203/ong-gia-va-bien-ca-va-hanh-phuc-ngan-ngui-cua-francis-macomber.jpg"
    },
    {
        id: 8,
        title: "Mắt Biếc",
        ...
        rating: 4.6,
        price: "98.000đ",
        summary: "Chuyện tình học trò trong trẻo và day dứt qua góc nhìn của Ngạn dành cho Hà Lan.",
    ...
    },
    {
        ...
        rating: 4.8,
        price: "92.000đ",
        summary: "Hồi ký tuổi thơ thú vị cùng triết lý giáo dục nhân văn tại ngôi trường Tomoe.",
        image: "https://nuhado.co/wp-content/uploads/2020/05/totto-chan-ben-cua-so.jpg"
    },
    {
        id: 10,
        ...
        rating: 4.7,
        price: "110.000đ",
        summary: "Hành trình phiêu bạt của cậu bé Remi đầy gian truân nhưng cũng thấm đẫm tình người.",
        image: "https://thegioivanhoc.com/wp-content/uploads/2024/02/khong-gia-dinh.jpg"
    },
    {
        id: 11,
        ...
        rating: 4.9,
        price: "350.000đ",
        summary: "Bộ sử thi giả tưởng kinh điển về cuộc chiến chống lại bóng tối ở Trung Địa.",
    ...
    },
    {
        ...
        rating: 4.8,
        price: "135.000đ",
        summary: "Tiểu thuyết nổi tiếng về gia đình mafia Corleone và những xung đột quyền lực.",
...
function renderBooks(searchText = "") {
  ...
  const filteredBooks = books.filter((book) => bookMatchesQuery(book, searchText));

  if (filteredBooks.length === 0) {
    container.innerHTML = '<p class="no-results" role="status">Không có sách nào phù hợp.</p>';
    return;
  }
...
productList.addEventListener("click", (event) => {
  ...
  const filteredBooks = books.filter((book) => bookMatchesQuery(book, searchInput.value));
